                                    ...
                                    <div class="col-lg-12 justify-content-center mt-4">
                                        <form method="POST" action="{{ route ('password.update')}}">
                                            ...
                                            <div class="form-row justify-content-center mt-4">
                                                <div class="col-lg-10">
                                                    <input id="email" placeholder="E-Mail Address" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="off" autofocus>
                                                    @error('email')
