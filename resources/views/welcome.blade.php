                ...
                <div class="container">
                    <div class="row justify-content-center mt-4">
                        <div class="col-md-9">
                            <div class="card mb-3">
                                <h2>
                                    COVID-19 Guide System
                                </h2>
                                <p>
                                    Let's begin helping our COVID-19 Survivors by giving support to them during their difficult time
                                </p>
                                <a href="{{ route('login') }}" class="btn">Let's Get Started</a>
                            </div>
                        </div>
                    </div>
                </div>
